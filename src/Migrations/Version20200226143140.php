 ...
 */
final class Version20200226143140 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property ADD image_name VARCHAR(255) NOT NULL, ADD updated_at DATETIME NOT NULL, CHANGE price price INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property DROP image_name, DROP updated_at, CHANGE price price INT DEFAULT NULL');
